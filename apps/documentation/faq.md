---
description: >-
  Frequently Asked Questions about the Cinema Project - development,
  architecture, and common issues
---
...
\{% @mermaid/diagram content="sequenceDiagram participant C as Client participant A as API
...
2. **Create detailed bug report** - Open an issue: https://github.com/mathieusouflis/HETIC-projet-cinema/issues/new
...
2. **Create feature request** - Open an issue: https://github.com/mathieusouflis/HETIC-projet-cinema/issues/new
