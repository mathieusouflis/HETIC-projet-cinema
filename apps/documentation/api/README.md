---
description: Comprehensive overview of the Cinema API architecture, features, and capabilities
---
...
2. [Creating a Module](guides/creating-module.md) - Add new features
3. [Adding Endpoints](guides/adding-endpoints.md) - Extend existing modules
4. [Writing Tests](guides/writing-tests.md) - Ensure code quality
...
**Next Steps:** Start with the [Architecture Overview](architecture/README.md) to understand the system design, or jump straight to [Quick Start](guides/quick-start.md) to begin development.