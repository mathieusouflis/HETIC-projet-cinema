...
export default function LoginForm() {
  ...
  return (
    <form className="flex flex-col gap-4">
      ...
      {/* Forgot password */}
      <a href="/forgot-password" className="text-[14px] mt-2 underline self-start">
        Forgot password?
      </a>
      ...
      <div className="flex gap-4 mt-6">
        <button
          type="button"
          className="bg-[var(--secondary)] text-[var(--secondary-foreground)] rounded-full px-6 py-2 font-semibold"
        >
          Create Account
        </button>
        <button
