  ...
  "rounded-lg p-[3px] group-data-[orientation=horizontal]/tabs:h-9 data-[variant=line]:rounded-none group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        ...
        profile:
          "surface-inset rounded-[28px] gap-2 p-2 dark:border-white/10 dark:bg-white/6",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=profile]/tabs-list:shrink-0 group-data-[variant=profile]/tabs-list:rounded-full group-data-[variant=profile]/tabs-list:px-4 group-data-[variant=profile]/tabs-list:py-2.5 group-data-[variant=profile]/tabs-list:font-medium group-data-[variant=profile]/tabs-list:capitalize group-data-[variant=profile]/tabs-list:data-[state=active]:bg-foreground group-data-[variant=profile]/tabs-list:data-[state=active]:text-background group-data-[variant=profile]/tabs-list:data-[state=active]:shadow-sm group-data-[variant=profile]/tabs-list:hover:bg-background/70 dark:group-data-[variant=profile]/tabs-list:data-[state=active]:bg-white dark:group-data-[variant=profile]/tabs-list:data-[state=active]:text-neutral-950 dark:group-data-[variant=profile]/tabs-list:hover:bg-white/8",
        className
      )}
      {...props}
    />
