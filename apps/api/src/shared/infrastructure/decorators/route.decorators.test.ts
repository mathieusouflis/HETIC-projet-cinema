...
import { Get, Post, Put, Patch, Delete, Summary, Description } from './route.decorators.js';
...
describe('Route Decorators tests', () => {
  ...
  describe('Get decorator', () => {
    ...
    it('should register a GET route with options object', () => {
      class TestController {
        @Get({ path: '/users/:id', summary: 'Get user by ID', description: 'Retrieves a single user' })
        getUser() {}
      }
  ...
  describe('Post decorator', () => {
    ...
    it('should register a POST route with options object', () => {
      class TestController {
        @Post({ path: '/users', summary: 'Create user', description: 'Creates a new user' })
        createUser() {}
      }
  ...
  describe('Delete decorator', () => {
    ...
    it('should register a DELETE route with options object', () => {
      class TestController {
        @Delete({ path: '/users/:id', summary: 'Delete user', description: 'Removes a user' })
        deleteUser() {}
      }
  ...
  describe('Description decorator', () => {
    it('should add description to an existing route', () => {
      ...
      expect(routes[0]?.description).toBe('Retrieves all users from the database');
    });
