...
import { QuerySerieRequest } from "../dto/requests/query-serie.validator.js";
import { QuerySerieResponse } from "../dto/response/query-serie.validator.js";
...
export class QuerySerieUseCase {
  ...
  async execute(query: QuerySerieRequest): Promise<QuerySerieResponse> {
    const result = await this.serieRepository.listSeries(query.title, undefined, undefined, {
      page: query.page ?? 1,
