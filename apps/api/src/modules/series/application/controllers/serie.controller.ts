...
import { QuerySerieUseCase } from "../use-cases/query-serie.use-case.js";
import { GetSerieByIdUseCase } from "../use-cases/get-serie-by-id.use-case.js";
import { QuerySerieRequest, querySerieRequestSchema } from "../dto/requests/query-serie.validator.js";
import { QuerySerieResponse, querySerieResponseSchema } from "../dto/response/query-serie.validator.js";
import { GetSerieByIdValidatorParams, getSerieByIdValidatorParams } from "../dto/requests/get-serie-by-id-params.validator.js";
import { GetSerieByIdResponse, getSerieByIdResponseSchema } from "../dto/response/get-serie-by-id-response.validator.js";
...
export class SeriesController extends BaseController {
  ...
  @ApiResponse(200, "Series retrieved successfully", createSuccessResponse(querySerieResponseSchema))
  ...
  getSerieById = asyncHandler(async (req, res): Promise<GetSerieByIdResponse> => {
