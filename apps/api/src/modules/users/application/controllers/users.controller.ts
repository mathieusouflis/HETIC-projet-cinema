...
import { Delete, Get, Patch } from '../../../../shared/infrastructure/decorators/route.decorators.js';
...
import { patchIdBodySchema, patchIdParamsSchema } from '../dto/requests/patch-id.validator.js';
...
export class UsersController extends BaseController {
  ...
  @ApiResponse(200, 'User retrieved successfully', createSuccessResponse(getIdResponseSchema))
  ...
  @ApiResponse(200, 'Users retrieved successfully', createSuccessResponse(getResponseSchema))
  @ApiResponse(400, 'Invalid pagination parameters', validationErrorResponseSchema)
  ...
  const { page, limit, offset, sort } = req.query as unknown as GetQueryDTO
    ...
    const result = await this.getUsersUseCase.execute({ page, limit, offset, sort });
  ...
  @ApiResponse(200, 'User updated successfully', createSuccessResponse(patchIdResponseSchema))
  @ApiResponse(400, 'Invalid input data', validationErrorResponseSchema)
  @ApiResponse(401, 'Not authenticated', unauthorizedErrorResponseSchema)
  @ApiResponse(403, 'Forbidden - cannot update other users', forbiddenErrorResponseSchema)
  @ApiResponse(404, 'User not found', notFoundErrorResponseSchema)
  ...
  @ApiResponse(400, 'Invalid user ID', validationErrorResponseSchema)
  @ApiResponse(401, 'Not authenticated', unauthorizedErrorResponseSchema)
  @ApiResponse(403, 'Forbidden - cannot delete other users', forbiddenErrorResponseSchema)
  @ApiResponse(404, 'User not found', notFoundErrorResponseSchema)
  ...
  @Protected()
  @ApiResponse(200, 'User profile retrieved successfully', createSuccessResponse(getMeResponseSchema))
  @ApiResponse(401, 'Not authenticated', unauthorizedErrorResponseSchema)
  ...
  @ApiResponse(200, 'User profile updated successfully', createSuccessResponse(patchMeResponseSchema))
  @ApiResponse(400, 'Invalid input data', validationErrorResponseSchema)
  @ApiResponse(401, 'Not authenticated', unauthorizedErrorResponseSchema)
