...
describe("RefreshTokenUseCase", () => {
  ...
  it("should throw an error when the refresh token is invalid", async () => {
    const invalidToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkXVCJ9.eyJzdWIiOiIxMj0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30";
    await expect(useCase.execute({ refreshToken: invalidToken })).rejects.toThrow("Invalid or expired refresh token");
  });
