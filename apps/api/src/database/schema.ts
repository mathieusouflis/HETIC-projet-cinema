import { pgTable, index, unique, check, uuid, varchar, text, boolean, timestamp, foreignKey, inet, date, integer, numeric, jsonb, primaryKey, pgView, bigint } from "drizzle-orm/pg-core"
...
export const users = pgTable("users", {
	...
	index("idx_users_oauth").using("btree", table.oauthProvider.asc().nullsLast().op("text_ops"), table.oauthId.asc().nullsLast().op("text_ops")),
	unique("users_email_key").on(table.email),
	unique("users_username_key").on(table.username),
	check("oauth_or_email", sql`((oauth_provider IS NOT NULL) AND (oauth_id IS NOT NULL)) OR ((email IS NOT NULL) AND (password_hash IS NOT NULL))`),
]);
...
export const refreshTokens = pgTable("refresh_tokens", {
	...
	index("idx_refresh_tokens_expires").using("btree", table.expiresAt.asc().nullsLast().op("timestamptz_ops")),
...
export const friendships = pgTable("friendships", {
	...
	index("idx_friendships_friend").using("btree", table.friendId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("uuid_ops")),
	index("idx_friendships_user").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const content = pgTable("content", {
	...
	index("idx_content_rating").using("btree", table.averageRating.desc().nullsFirst().op("numeric_ops")),
	index("idx_content_slug").using("btree", table.slug.asc().nullsLast().op("text_ops")),
	index("idx_content_tmdb").using("btree", table.tmdbId.asc().nullsLast().op("int4_ops")),
	index("idx_content_type").using("btree", table.type.asc().nullsLast().op("text_ops")),
	index("idx_content_year").using("btree", table.year.asc().nullsLast().op("int4_ops")),
	...
	check("valid_type", sql`(type)::text = ANY ((ARRAY['movie'::character varying, 'series'::character varying])::text[])`),
]);
...
export const contentCredits = pgTable("content_credits", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	...
	index("idx_credits_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	index("idx_credits_person").using("btree", table.personId.asc().nullsLast().op("uuid_ops"), table.role.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const people = pgTable("people", {
	...
	index("idx_people_tmdb").using("btree", table.tmdbId.asc().nullsLast().op("int4_ops")),
...
export const seasons = pgTable("seasons", {
	...
	index("idx_seasons_series").using("btree", table.seriesId.asc().nullsLast().op("int4_ops"), table.seasonNumber.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const episodes = pgTable("episodes", {
	...
	index("idx_episodes_season").using("btree", table.seasonId.asc().nullsLast().op("int4_ops"), table.episodeNumber.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const conversationParticipants = pgTable("conversation_participants", {
	...
	index("idx_conv_participants_conv").using("btree", table.conversationId.asc().nullsLast().op("uuid_ops")),
	index("idx_conv_participants_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const watchparties = pgTable("watchparties", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	...
	index("idx_watchparties_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	index("idx_watchparties_content_related").using("btree", table.contentId.asc().nullsLast().op("uuid_ops"), table.seasonId.asc().nullsLast().op("uuid_ops"), table.episodeId.asc().nullsLast().op("uuid_ops")),
	index("idx_watchparties_creator").using("btree", table.createdBy.asc().nullsLast().op("uuid_ops")),
	index("idx_watchparties_episode").using("btree", table.episodeId.asc().nullsLast().op("uuid_ops")),
	index("idx_watchparties_scheduled").using("btree", table.scheduledAt.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("timestamptz_ops")),
	index("idx_watchparties_season").using("btree", table.seasonId.asc().nullsLast().op("uuid_ops")),
	index("idx_watchparties_status").using("btree", table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.createdBy],
			foreignColumns: [users.id],
...
export const messages = pgTable("messages", {
	...
	index("idx_messages_conversation").using("btree", table.conversationId.asc().nullsLast().op("timestamptz_ops"), table.createdAt.desc().nullsFirst().op("timestamptz_ops")),
	index("idx_messages_watchparty").using("btree", table.watchpartyId.asc().nullsLast().op("uuid_ops"), table.createdAt.desc().nullsFirst().op("uuid_ops")),
	foreignKey({
			columns: [table.conversationId],
			foreignColumns: [conversations.id],
...
export const ratings = pgTable("ratings", {
	...
	index("idx_ratings_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
...
export const reviews = pgTable("reviews", {
	...
	index("idx_reviews_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops"), table.createdAt.desc().nullsFirst().op("timestamptz_ops")),
	index("idx_reviews_parent").using("btree", table.parentReviewId.asc().nullsLast().op("uuid_ops")),
...
export const userWatchlist = pgTable("user_watchlist", {
	...
	index("idx_watchlist_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	index("idx_watchlist_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const lists = pgTable("lists", {
	...
	index("idx_lists_public").using("btree", table.isPublic.asc().nullsLast().op("timestamptz_ops"), table.createdAt.desc().nullsFirst().op("timestamptz_ops")),
	index("idx_lists_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const listItems = pgTable("list_items", {
	...
	index("idx_list_items_list").using("btree", table.listId.asc().nullsLast().op("int4_ops"), table.orderIndex.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const watchpartyParticipants = pgTable("watchparty_participants", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	...
	index("idx_watchparty_participants_party").using("btree", table.watchpartyId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("uuid_ops")),
	index("idx_watchparty_participants_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.watchpartyId],
			foreignColumns: [watchparties.id],
	...
	unique("unique_watchparty_participant").on(table.watchpartyId, table.userId),
]);

export const watchpartyInvitations = pgTable("watchparty_invitations", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	watchpartyId: uuid("watchparty_id").notNull(),
	...
	index("idx_invitations_invitee").using("btree", table.inviteeId.asc().nullsLast().op("uuid_ops")),
	index("idx_invitations_token").using("btree", table.inviteToken.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.watchpartyId],
			foreignColumns: [watchparties.id],
...
export const userActivityLogs = pgTable("user_activity_logs", {
	...
	index("idx_activity_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	index("idx_activity_type").using("btree", table.eventType.asc().nullsLast().op("text_ops")),
...
export const notifications = pgTable("notifications", {
	...
	index("idx_notifications_user").using("btree", table.userId.asc().nullsLast().op("timestamptz_ops"), table.isRead.asc().nullsLast().op("uuid_ops"), table.createdAt.desc().nullsFirst().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const contentCategories = pgTable("content_categories", {
	...
	index("idx_content_categories_category").using("btree", table.categoryId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.contentId],
			foreignColumns: [content.id],
	...
	primaryKey({ columns: [table.contentId, table.categoryId], name: "content_categories_pkey"}),
]);
...
export const reviewLikes = pgTable("review_likes", {
	...
	primaryKey({ columns: [table.userId, table.reviewId], name: "review_likes_pkey"}),
]);
...
export const listLikes = pgTable("list_likes", {
	...
	primaryKey({ columns: [table.userId, table.listId], name: "list_likes_pkey"}),
]);

export const peopleLikes = pgTable("people_likes", {
	userId: uuid("user_id").notNull(),
	personId: uuid("person_id").notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow(),
}, (table) => [
	...
	primaryKey({ columns: [table.userId, table.personId], name: "people_likes_pkey"}),
]);
export const popularContent = pgView("popular_content", {	id: uuid(),
